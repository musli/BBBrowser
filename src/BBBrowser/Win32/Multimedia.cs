...
namespace Win32
{
	...
	public abstract class WinMM
	{
		...
		[DllImport("winmm")] public static extern int waveOutGetVolume(UInt32 uDeviceID, out UInt32 lpdwVolume);
		...
		[DllImport("winmm")] public static extern int waveOutSetVolume(uint uDeviceID, uint dwVolume);
